...
<div class="featured-area featured-video">
	<div class="penci-video-overlay-background featured-video-background<?php if( get_theme_mod( 'penci_featured_video_img_mobile' ) ): ?> has-bg-image<?php endif; ?>" id="penci-featured-video-bg" style="background-image: url('<?php echo get_theme_mod( 'penci_featured_video_img_mobile' );?> " data-property="<?php echo esc_attr( $video_property ); ?>">
