...
if ( ! function_exists( 'penci_load_scripts' ) ) {
	...
	function penci_load_scripts() {
		...
		wp_enqueue_style( 'penci_style', get_stylesheet_directory_uri() . '/style.css', array(), '6.1' );


		// Enqueue script
		wp_enqueue_script( 'penci-libs-js', get_template_directory_uri() . '/js/libs-script.min.js', array( 'jquery' ), '6.1', true );
		wp_register_script( 'penci-facebook-js', get_template_directory_uri() . '/js/facebook.js' , '', '6.1', true );
		...
		wp_enqueue_script( 'main-scripts', get_template_directory_uri() . '/js/main.js', array( 'jquery' ), '6.1', true );
		wp_localize_script( 'main-scripts', 'ajax_var_more', $localize_script );

		wp_enqueue_script( 'penci_ajax_like_post', get_template_directory_uri() . '/js/post-like.js', array( 'jquery' ), '6.1', true );
