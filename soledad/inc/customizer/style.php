...
function pencidesign_customizer_css() {
    ...
    <style type="text/css">
		...
		.penci-featured-cat-seemore.penci-btn-make-button a { font-family: <?php echo sanitize_text_field( $font_family_title_end ); ?>; font-weight: normal; }
		...
		.archive-box h1, .gallery .gallery-caption, .widget input[type="submit"], .widget button[type="submit"], .contact-form input[type=submit], ul.penci-topbar-menu > li a, div.penci-topbar-menu > ul > li a, .penci-recipe-index-wrap .penci-index-more-link a, #bbpress-forums #bbp-search-form .button, .penci-menu-hbg .menu li a, #sidebar-nav .menu li a, .penci-readmore-btn.penci-btn-make-button a, .penci-featured-cat-seemore.penci-btn-make-button a { font-weight: <?php echo get_theme_mod('penci_font_weight_title'); ?>; }
		<?php
		}
		?>
		...
		if( $penci_hbg_width && $penci_hbg_width > 270 && $penci_hbg_width < 500 ){
			...
			echo '.penci-menuhbg-open .penci-menu-hbg.penci-menu-hbg-left{ left: ' . $penci_hbg_width . 'px; }';
		}
		...
		if( $mhbg_bgimgcolor ) { echo '.penci-menu-hbg{background-image: url( ' . esc_attr( $mhbg_bgimgcolor ) . ' );}';}
		...
		if( $mhbg_bordercolor ){
			...
			echo '.penci-menu-hbg .widget input[type="search"], .widget input[type="password"]{border-color: ' . $mhbg_bordercolor . ';}';
		}
		...
		if( $mhbgicon_color ) { echo '.header-social.sidebar-nav-social a i{ color:' . esc_attr( $mhbgicon_color ) . ';}';}
		if( $mhbgicon_hover_color ) { echo '.penci-menu-hbg-inner .header-social.sidebar-nav-social a:hover i{ color:' . esc_attr( $mhbgicon_hover_color ) . ';}';}
