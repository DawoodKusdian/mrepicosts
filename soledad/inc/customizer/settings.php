...
function pencidesign_register_theme_customizer( $wp_customize ) {
	...
	$wp_customize->add_section( $section_menu_hbg, array(
		'title'       => esc_html__( 'Hamburger Menu Options', 'soledad' ),
		'priority'    => 6,
	) );
	...
	$wp_customize->add_control( new WP_Customize_Control(
		...
		array(
			'label'    => esc_html__( 'Hide Menu Hamburger Icon on Mobile', 'soledad' ),
			'section'  => $section_menu_hbg,
			'type'     => 'checkbox',
	...
	$wp_customize->add_control( new Customize_Number_Control( $wp_customize, 'penci_hbg_width', array(
		'label'    => 'Custom Width for Menu Hamburger ( min 270, max 500 )',
		'description' => 'Min width is 270px',
		'section'  => $section_menu_hbg,
	...
	$wp_customize->add_control( new Customize_Number_Control( $wp_customize, 'penci_hbg_size_icon', array(
		'label'    => 'Custom Size for Menu Hamburger Icon ( min 14, max 30 )',
	...
	$wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize, 'penci_menu_hbg_logo', array(
		'label'    => esc_html__( 'Custom Logo for Menu Hamburger', 'soledad'),
		'section'  => $section_menu_hbg,
	...
	$wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'custom_logo_hamburger', array(
		'label'       => 'Custom Link for Logo on Menu Hamburger',
		'section'     => $section_menu_hbg,
	...
	$wp_customize->add_control( new Customize_Number_Control( $wp_customize, 'hbg_logo_max_width', array(
		'label'    => 'Set A Max Width for Logo on Menu Hamburger',
		'section'  => $section_menu_hbg,
	...
	$wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'penci_menu_hbg_sitetitle', array(
		'label'    => esc_html__( 'Site Title on Menu Hamburger', 'soledad' ),
		'section'  => $section_menu_hbg,
	...
	$wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'penci_menu_hbg_desc', array(
		'label'    => esc_html__( 'Site Description on Menu Hamburger', 'soledad' ),
		'section'  => $section_menu_hbg,
	...
	$wp_customize->add_control( new WP_Customize_Control(
		...
		array(
			'label'    => esc_html__( 'Hide Main Menu on Hamburger Sidebar', 'soledad' ),
			'section'  => $section_menu_hbg,
			'type'     => 'checkbox',
	...
	$wp_customize->add_control( new Customize_Number_Control( $wp_customize, 'font_size_menu_hbg', array(
		'label'    => 'Custom Font Size for Hambuger Menu Items',
		'section'  => $section_menu_hbg,
	...
	$wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'penci_menu_hbg_footer_text', array(
		'label'    => esc_html__( 'Footer Text', 'soledad' ),
		'section'  => $section_menu_hbg,
	...
	$wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize, 'penci_menu_hbg_bgimg', array(
		'label'    => esc_html__( 'Menu Hamburger Background Image', 'soledad' ),
		'section'  => $section_menu_hbg,
		'settings' => 'penci_menu_hbg_bgimg',
	) ) );

	$options_color_menu_hbg1 = array(
		'penci_mhbg_icon_toggle_color'  => esc_html__( 'Menu Hamburger Icon Color on Main Bar', 'soledad' ),
		'penci_mhbg_icon_toggle_hcolor' => esc_html__( 'Menu Hamburger Icon Hover Color Main Bar', 'soledad' ),
		'penci_mhbg_bgcolor'            => esc_html__( 'Menu Hamburger Background Color', 'soledad' ),
		'penci_mhbg_textcolor'          => esc_html__( 'Menu Hamburger Text Color', 'soledad' ),
		'penci_mhbg_closecolor'         => esc_html__( 'Close Icon Color', 'soledad' ),
		'penci_mhbg_closehover'         => esc_html__( 'Close Icon Hover Color', 'soledad' ),
		'penci_mhbg_bordercolor'        => esc_html__( 'Custom General Border Color', 'soledad' ),
